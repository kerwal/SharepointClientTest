...
namespace Kerwal.SharepointOnline
{
    ...
    /// </summary>
    public class ClientContextCreator : IDisposable
    {
        #region Construction

        /// <summary>
        /// Creates an ClientContext with authenticated cookies
        /// </summary>
        /// <param name="targetSiteUrl"></param>
        /// <param name="popUpWidth"></param>
        /// <param name="popUpHeight"></param>
        public ClientContextCreator(string targetSiteUrl, string username, string password)
        {
